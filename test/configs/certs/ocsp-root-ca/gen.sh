...
################################################################################
# Create the server certs using the intermediate CA.
################################################################################

$openssl_bin genrsa -out ./interCA/private/server.key.pem

$openssl_bin req --batch -config intermediate.cnf \
...
cat interCA/certs/server.cert.pem interCA/certs/intermediate.cert.pem > interCA/certs/server-ca-chain.cert.pem
